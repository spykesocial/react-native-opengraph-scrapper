  ...
  context('should return correct Open Graph Info + charset info', function () {
    ...
    it.skip('when charset is utf-8 - signanthealth', function () {
      return ogs({
        ...
        expect(result.articleModifiedTime).to.be.eql('2020-09-15T13:50:38+00:00');
    ...
    it('csdn', function () {
      return ogs({ url: 'https://jshemas.github.io/openGraphScraperPages/csdn' })
        .then(function (data) {
          ...
          expect(mediaResults(result.ogImage).length).to.be.eql(83);
    ...
    it('sohu', function () {
      return ogs({ url: 'https://jshemas.github.io/openGraphScraperPages/sohu' })
        .then(function (data) {
          ...
          expect(mediaResults(result.ogImage).length).to.be.eql(43);
          expect(result.charset).to.be.eql('utf8');
    ...
    it('weibo', function () {
      return ogs({ url: 'https://jshemas.github.io/openGraphScraperPages/weibo' })
        .then(function (data) {
          ...
          expect(mediaResults(result.ogImage).length).to.be.eql(14);
          expect(result.charset).to.be.eql('utf8');
    ...
    it('zhanqi', function () {
      return ogs({ url: 'https://jshemas.github.io/openGraphScraperPages/zhanqi' })
        .then(function (data) {
          ...
          expect(mediaResults(result.ogImage).length).to.be.eql(33);
          expect(result.charset).to.be.eql('utf8');
